...
def main():
    ...
    #gamma should be 0.6. seed 22, boundary test
    #seed_array = np.random.randint(0, 65000, size=100)
    #VSA("L21", "C:\\Users\\yangw\\Desktop\\CG_projects\\vsa_project\\testsurface1.obj", seed_array)

    #gamma should be 0.9
    #seed_array = np.random.randint(0, 65000, size=50)
    #VSA("H1", "C:\\Users\\yangw\\Desktop\\CG_projects\\vsa_project\\testsurface1.obj", seed_array)

    # gamma should be 1.5
    #seed_array = np.random.randint(0, 65000, size=50) 
    #VSA("H1", "C:\\Users\\yangw\\Desktop\\CG_projects\\vsa_project\\torus.obj", seed_array)

    # gamma should be 0.8. seed 82
    #seed_array = np.random.randint(0, 65000, size=200) 
    #VSA("H1", "C:\\Users\\yangw\\Desktop\\CG_projects\\vsa_project\\torus.obj", seed_array)

    # gamma should be 0.4. adaptive alpha. Optimize
    #seed_array = np.random.randint(0, 80000, size=200)
    #VPR("H1", "C:\\Users\\yangw\\Desktop\\CG_projects\\vsa_project\\stanford-bunny2.obj", seed_array)
    
    # gamma should be 1.2. Or adaptive 0.6. Optimize. Seed 82
    #seed_array = np.random.randint(0, 80000, size=70)
    #VPR("H1", "C:\\Users\\yangw\\Desktop\\CG_projects\\vsa_project\\stanford-bunny2.obj", seed_array)

    # gamma should be 2.5. adaptive alpha 0.1. smoothing. seed 22. optimize. test planar
    #seed_array = np.random.randint(0, 81033, size=200)
    #VSA("L21", "C:\\Users\\yangw\\Desktop\\CG_projects\\vsa_project\\arch3.obj", seed_array)

    # adaptive alpha 0.45. smoothing. seed 22. optimize. test planar
    seed_array = np.random.randint(0, 89233, size=420)
    VPR("H1", "C:\\Users\\yangw\\Desktop\\CG_projects\\vsa_project\\pavillion3.obj", seed_array)

    # gamma should be 1.4. No smoothing. seed 22. optimize
    #seed_array = np.random.randint(0, 70900, size=200)
    #VSA("L2", "C:\\Users\\yangw\\Desktop\\CG_projects\\vsa_project\\arch4.obj", seed_array)

    # test convergence. adaptive gamma should be 0.4. static gamma should be 1.4. Smoothing. seed 22.
    #seed_array = np.random.randint(0, 10116, size=30)
    #VSA("H1", "C:\\Users\\yangw\\Desktop\\CG_projects\\vsa_project\\converge.obj", seed_array)

    cam = ps.get_view_camera_parameters()

    print("Position:", cam.get_position())
    print("Look direction:", cam.get_look_dir())
    print("Up direction:", cam.get_up_dir())
    print("Right direction:", cam.get_right_dir())
    print("FOV:", cam.get_fov_vertical_deg())
    print("Aspect:", cam.get_aspect())
